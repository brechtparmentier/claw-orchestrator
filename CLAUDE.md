...
This project is indexed by GitNexus as **claw-orchestrator** (2447 symbols, 7113 relationships, 209 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/claw-orchestrator/context` | Codebase overview, check index freshness |
| `gitnexus://repo/claw-orchestrator/clusters` | All functional areas |
| `gitnexus://repo/claw-orchestrator/processes` | All execution flows |
| `gitnexus://repo/claw-orchestrator/process/{name}` | Step-by-step execution trace |
